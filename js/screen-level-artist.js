...
const INNERHTML = `<section class="main main--level main--level-artist">
...
const screenLevelArtist = getElement(INNERHTML);
const answerBtns = screenLevelArtist.querySelectorAll(`.main-answer`);

answerBtns.forEach((btn) => {
  btn.addEventListener(`click`, (evt) => {
    evt.preventDefault();
    setNextScreen(screenLevelGenre);
  });
});
